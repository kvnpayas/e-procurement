...
<body>
  ...
  <div class="content-text">
    <p>Dear {{ $name }}</p>
    <p>We are pleased to inform you that your account has been successfully created. To get started, please click the link below to set your password and access your account:</p>
