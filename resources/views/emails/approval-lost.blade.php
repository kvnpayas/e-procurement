...
<body>
  ...
  <div class="content-text">
    <p>Dear Bidder,</p>
    <p>Greetings!</p>
    <p>We are pleased to announce that the winning bidder for <span
      style="text-decoration: underline; font-weight:bolder">{{ $bidding->project_id }} -
      {{ $bidding->title }}</span> is {{ $winnerVendor }}. Thank you for your participation. We highly appreciate your
      enthusiasm and professionalism throughout the bidding process. We do hope that you’ll join us again in our next
      sourcing events.
    </p>
    <p>
