  ...
  <div class="content-text">
    ...
    <p>
      This is to inform all interested bidders that the bidding process for <span
        ...
        {{ $bidding->title }}</span> is officially closed effective {{ date('F j, Y, g:i A', strtotime(now())) }}.
    </p>
    <p>
      No further bids will be accepted. The evaluation process will commence shortly, and the winning bidder will be announced as scheduled.
    </p>
    <p>
