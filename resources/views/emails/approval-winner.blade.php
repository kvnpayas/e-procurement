...
<body>
  ...
  <div class="content-text">
    <p>Dear Bidder,</p>
    <p>Greetings!</p>
    <p>We are pleased to announce that after careful evaluation of all the submitted proposals for
      <span style="text-decoration: underline; font-weight:bolder">{{ $bidding->project_id }} -
        {{ $bidding->title }}</span> we have identified your company, {{ $vendor }}, as the winning bidder for the
      project.
    </p>
    <p>
      We highly appreciate your enthusiasm and professionalism throughout the bidding process.
    </p>
    <p>
