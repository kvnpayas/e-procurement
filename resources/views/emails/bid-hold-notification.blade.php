...
<body>
  ...
  <div class="content-text">
    ...
    <p>Greetings!</p>
    <p>
      This is to inform you that the bid process for <span style="text-decoration: underline; font-weight:bolder">{{ $bidding->project_id }} - {{ $bidding->title }}</span> has been temporarily placed on hold. An update on the status of the bid will be provided to you as soon as possible. 
    </p>
    <p>
      Respectfully,
    </p>
  ...
  <div class="content-contact">
    ...
    <div>
      <span>Email: <span style=" text-decoration: underline; color: blue; cursor: pointer;">tei_purchasing@teiph.com</span></span>
    </div>
  </div>
  <div class="content-contact">
    <div>
