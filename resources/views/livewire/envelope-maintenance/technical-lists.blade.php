                ...
                <div class="flex">
                  ...
                  <div class="mt-1.5 pl-2">
                    <label class="inline-flex items-center cursor-pointer">
                      ...
                      <span class="ms-3 text-sm font-medium">Show Current Technicals</span>
                    </label>
                  </div>
                </div>
              </div>
                ...
                <tr class="bg-white border-b" wire:key="technical-{{ $technical->id }}">
                  ...
                  <td class="px-6 py-4">
                    <div class="flex items-center me-4">
                      <input wire:model="checkTechnicals.{{ $technical->id }}" value="{{ $technical->id }}"
                        type="checkbox"
...
@script
  <script>
    $wire.on('openAddModal', () => {
      var modalEditElement = document.getElementById('technicals-modal');
