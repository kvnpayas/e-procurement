<div class="overflow-x-auto shadow-md sm:rounded-lg">
  <table class="w-full text-sm text-left rtl:text-right text-gray-500">
    <caption class="p-5 text-lg font-semibold text-left rtl:text-right tei-text-secondary bg-white ">
      Eligibility Groups
      <p class="mt-1 text-sm font-normal text-gray-500 ">Assign eligibilities to groups.
      </p>
          ...
          <td class="px-6">
            <div class="flex gap-4">
              ...
              @if (roleAccessRights(['create', 'update']))
                <div>
                  <button
                    wire:click="$dispatch('eligibilitiesModal', {id: {{ $group->id }}})"
      ...
      <div class="relative bg-white rounded-lg shadow">
        ...
        <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t">
          <h3 class="text-xl font-extrabold tei-text-primary">
            Create group for eligibilities
          </h3>
                ...
                <div class="mt-5">
                  ...
                  <div wire:loading.remove wire:target="editModal({{ $group->id }})">
                    <textarea id="message" rows="4"
                      ...
                      placeholder="Eligibility Description" wire:model="groupEditDescription"></textarea>
  ...
  {{-- Eligibility Lists --}}
  @livewire('envelope-maintenance.eligibility-lists-modal')
  {{-- End Eligibility Lists --}}
</div>
@script
  <script>
    $wire.on('closeModal', () => {
