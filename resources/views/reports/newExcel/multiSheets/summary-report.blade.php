...
<table>
  ...
  <tbody>
    ...
    @if ($data['projectbid']->status != 'Under Evaluation')
      <tr>
    ...
    @if ($data['projectbid']->status == 'Awarded')
      <tr>
        <td colspan="2">Awarded By</td>
        <td colspan="5">
          {{ $data['projectbid']->bidAward->awardedBy ? ucwords($data['projectbid']->bidAward->awardedBy->name) : '' }}
        </td>
      </tr>
      <tr>
        <td colspan="2">Award Date</td>
        <td colspan="5">
          {{ date('F j,Y h:i A', strtotime($data['projectbid']->bidAward->award_date)) }}
        </td>
      </tr>
    @endif
